...
function App() {
  ...
  return (
    <motion.div className='w-full h-screen flex items-center justify-center bg-[#f6f6f6]'>
      <motion.div 
        drag="y"
        className="w-[300px] h-52 rounded-md cursor-pointer"
        dragConstraints={{ top: 0, bottom: 60 }}
        style={{ y: y, marginTop: y >= 10 ? "-3em" : "0" }}
        onDragEnd={() => handleDrag()}
      >
        <motion.div className='flex flex-col w-[320px] h-[270px] rounded-md justify-start'>
          <motion.div className='h-[90px] z-10 bg-white p-3 flex flex-col rounded-t-md rounded-tr-md'>
          ...
          <motion.div className='h-[90px] bg-white origin-top p-3' style={{ scaleY: scaleX, opacity: scaleX }}>
            <p className='text-xs'>"if you've found this message kindly take some time to let us know about our latest newsletter, we would appericiate youre feedback"</p>
          </motion.div>
          <motion.div className='h-[90px] origin-top rounded-bl-md rounded-br-md px-3 py-1 bg-white border-t-[.3px] border-gray-100' style={{ translateY: translateY}}>
            <div className='flex flex-col justify-between h-full'>
              ...
              <span className='flex flex-row justify-evenly items-center gap-2'>
                <button className='w-full bg-[#374151] rounded-xl py-2 px-3 text-sm text-white flex flex-row items-center gap-1 justify-center'>
                ...
                <button className='w-full bg-[#fee2e2] rounded-xl py-2 px-3 text-sm text-red-500 flex flex-row items-center justify-center gap-1'>
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M360 184h-8c4.4 0 8-3.6 8-8v8h304v-8c0 4.4 3.6 8 8 8h-8v72h72v-80c0-35.3-28.7-64-64-64H352c-35.3 0-64 28.7-64 64v80h72v-72zm504 72H160c-17.7 0-32 14.3-32 32v32c0 4.4 3.6 8 8 8h60.4l24.7 523c1.6 34.1 29.8 61 63.9 61h454c34.2 0 62.3-26.8 63.9-61l24.7-523H888c4.4 0 8-3.6 8-8v-32c0-17.7-14.3-32-32-32zM731.3 840H292.7l-24.2-512h487l-24.2 512z"></path></svg>
                Delete</button>

                <button className='w-full bg-[#3b82f6] rounded-xl py-2 px-3 text-sm text-white flex flex-row items-center justify-center gap-1'>
